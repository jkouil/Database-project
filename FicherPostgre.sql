...
CREATE TABLE Emprunter (
    ...
    ISBN VARCHAR(255) NOT NULL REFERENCES Livre(ISBN),
...
CREATE TABLE Commander (
  ...
  Statut VARCHAR(20) CHECK (Statut IN ('en_attente', 'honoree', 'annulee')),
  DateDebut DATE,
  DureePrevue INTEGER
);
...
INSERT INTO Auteur (AuteurID, Nom, Nationalite, DateNaissance, Adresse) VALUES
    ...
    (25, 'Christopher Paolini', 'Americain', '1983-11-17', 'Montana'),
    (26, 'Karl Marx', 'Allemand', '1818-05-05', 'Treves'),
    (27, 'John Maynard Keynes', 'Britannique', '1883-06-05', 'Cambridge'),
    (28, 'Steven D. Levitt', 'Americain', '1967-05-29', 'New Orleans'),
    (29, 'Richard J. Gerrig', 'Americain', '1959-01-01', 'New York'),
...
INSERT INTO Livre (ISBN, Titre, DatePublication, Editeur, GenreID) VALUES
    ...
    ('9782070360024', 'L''etranger', '1942-05-01', 'Gallimard', 2),
    ('9780553293357', 'Foundation', '1951-06-01', 'Gnome Press', 1),
    ('9780140449266', 'Le Prince', '1532-01-01', 'Penguin Classics', 3),
    ('9780140449136', 'Les Miserables', '1862-01-01', 'Penguin Classics', 2),
...
INSERT INTO Adherent (Nom, Adresse, Email, Telephone, DateInscription) VALUES
    ...
    ('emilie Lefebvre', '987 avenue Cartier', 'emilie.lefebvre@gmail.com', '514-777-8888', '2024-03-05'),
    ('Marc-Andre Boucher', '111 rue de la Montagne', 'marc.boucher@yahoo.ca', '514-999-0000', '2023-11-17'),
    ('Chloe Lavoie', '222 avenue Laurier', 'chloe.lavoie@gmail.com', '514-246-1357', '2023-08-22'),
...
INSERT INTO Commander (ISBN, AdherentID, DateCommande, Statut, DateDebut, DureePrevue) VALUES
    ...
    ('9780451524935', 2, '2025-04-11', 'honoree', '2025-04-12', 14),
    ('9780140449136', 1, '2025-04-09', 'en_attente', '2025-04-18', 10),
    ('9780385472579', 2, '2025-04-13', 'annulee', '2025-04-15', 5),
    ('9780140449181', 1, '2025-04-14', 'honoree', '2025-04-15', 14),
    ('9782070360909', 3, '2025-04-12', 'en_attente', '2025-04-20', 7),
    ('9782070371875', 4, '2025-04-08', 'honoree', '2025-04-09', 10),
    ('9782070643029', 5, '2025-04-06', 'annulee', '2025-04-08', 5),
